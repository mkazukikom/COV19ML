...
diff_covid <- data.frame(
  BCORP1 = late_covid$BCORP1 - early_covid$BCORP1,
...
# 3x3 パネルの描画
plot_list <- list(
  draw_plot(early_covid, "BCORP1", "SARSCoV2_N", "Early"),
  draw_plot(late_covid, "BCORP1", "SARSCoV2_N", "Late"),
  draw_plot(diff_covid, "BCORP1", "SARSCoV2_N", "Δ"),
  
  draw_plot(early_covid, "BCORP1", "SARSCoV2_S1", "Early"),
  draw_plot(late_covid, "BCORP1", "SARSCoV2_S1", "Late"),
  draw_plot(diff_covid, "BCORP1", "SARSCoV2_S1", "Δ"),
  
  draw_plot(early_covid, "BCORP1", "SARSCoV2_RBD", "Early"),
  draw_plot(late_covid, "BCORP1", "SARSCoV2_RBD", "Late"),
  draw_plot(diff_covid, "BCORP1", "SARSCoV2_RBD", "Δ")
)
