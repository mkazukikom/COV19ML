...
metrics_df = pd.DataFrame({
    'Fold': range(1, n_fold + 1),
    'Accuracy (Train)': acc_list_all_tr,
    'Accuracy (Test)': acc_list_all_te,
    'AUC (Train)': auc_list_all_tr,
    'AUC (Test)': auc_list_all_te,
    'Recall (Train)': recall_list_all_tr,
    'Recall (Test)': recall_list_all_te,
    'Precision (Train)': precision_list_all_tr,
    'Precision (Test)': precision_list_all_te,
    'F1-score (Train)': f1score_list_all_tr,
    'F1-score (Test)': f1score_list_all_te,
    'MCC (Train)': mcc_list_all_tr,
    'MCC (Test)': mcc_list_all_te
})
display(metrics_df)
