# -*- coding: utf-8 -*-
"""xgboost_7class_allfeatures.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GB0Xh0XKgoPXMKLNb6EFw_ZECHuGXYnq
"""
...
for k, v in zip(df_imp_all.index, df_imp_all.feature_importance):
    if v>0:
        imp_dict[k] = v
xgb.plot_importance(imp_dict, xlabel="feature importance", max_num_features=30)
